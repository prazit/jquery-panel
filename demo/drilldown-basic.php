...
<html>
	<head>
		<title>DEMO&nbsp;-&nbsp;Basic|&nbsp;jQuery&nbsp;Drilldown</title>
		<meta charset="UTF-8">
	...
	<div id="container" class="top-padding--x5 columns draw-outside">
		<div class="column">
			<div id="header" class="margin--x6 padding--x6 center-text">
				<span class="no-text sym-play-circle-o symbol--x2 symbol--c3 ani ani-spin ani-infinite"></span>
				Basic drilldown without options, please see source code for detail.
			</div>
