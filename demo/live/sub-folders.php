...
<div id="folders-content">
	...
	<div class="folder">
		<div class="on-top-left fit-width fit-height background--c0"></div>
		<div class="child center-text padding--x10 text--c3">
			<a class="back button on-left left-margin--x10 symbol sym-chevron-left symbol--c5" href="#">&nbsp;</a>
