...
<html>
	<head>
		<title>DEMO&nbsp;-&nbsp;Right&nbsp;Panel&nbsp;Sweep&nbsp;|&nbsp;jQuery&nbsp;Panel</title>
		<meta charset="UTF-8">
	...
	<div id="container" class="top-padding--x5 columns draw-outside">
		<div class="column">
			<div id="header" class="margin--x6 padding--x6 center-text">
				...
				Right panel with custom sweep, please see source code for detail.
			</div>
